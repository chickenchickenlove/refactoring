package me.whiteship.refactoring._03_long_function._08_introdce_parameter_object.after_object;
    ...
    private void print() throws IOException, InterruptedException {
        ...
        try (FileWriter fileWriter = new FileWriter("participants.md");
            ...
            participants.forEach(p -> {
                ...
                String markdownForHomework = getMarkdownForParticipant(this.totalNumberOfEvents, p);
